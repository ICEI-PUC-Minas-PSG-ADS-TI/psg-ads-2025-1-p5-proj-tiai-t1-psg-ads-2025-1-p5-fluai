...
class SignUpRepositoryImpl(
    ...
    override suspend fun postUser(user: User) : Result<Unit> = remote.postUser(user.toDto()).onSuccess { local.saveUser(UserEntity(uid = "", username = user.username, email = user.email, authToken = "")) }
}